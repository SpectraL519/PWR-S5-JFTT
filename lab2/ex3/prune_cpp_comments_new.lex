...
<sc_none>{p_begin_multiline_docs}{p_anything}{p_end_multiline_comment} {
    PRINT_IF_OMIT;
}
<sc_none>{p_begin_singleline_comment}{p_anything_opt_break_lines} {}
<sc_none>{p_begin_multiline_comment}{p_anything}{p_end_multiline_comment} {}
